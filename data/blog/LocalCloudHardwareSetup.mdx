...
This post will cover the first step of acquiring and building hardware. Posts on the other setup steps can be found below: - [Initial server OS setup](/blog/LocalCloudServerSetup): To be written - [Configure remote access](/blog/LocalCloudRemoteAccess): To be written
