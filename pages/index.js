...
import BlogClickable from '@/components/BlogClickable'
        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
              Hi, this is{' '}
              <span className="text-primary-color-500 dark:text-primary-color-dark-500">David</span>
            </h1>
          ...
          <div className="flex items-center justify-center">
            <div className="grid grid-cols-1 grid-rows-3 gap-8 py-12">
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r  from-pink-600 to-purple-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                  <Link href="https://docs.google.com/document/d/1JPS-ndUcGT_0KC3jnhnIfNjIXPx9aiyv6p8W_wr9mX4/edit?usp=sharing">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
          ...
          {posts.slice(0, MAX_DISPLAY).map((frontMatter) => {
            return (
              <li key={frontMatter.title}>
                <BlogClickable frontMatter={frontMatter} />
              </li>
            )
          })}
        </ul>
